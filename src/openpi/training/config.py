...
_CONFIGS = [
    ...
    # AWR chunk-weighted BC - red_book_05_21 - topreward
    TrainConfig(
        name="awr_chunk_red_book_topreward",
        model=pi0_config.Pi0Config(pi05=True, paligemma_variant="gemma_2b_lora"),
        data=LeRobotYAMDataConfig(
            repo_id="memmelma/red_book_05_21",
            base_config=DataConfig(
                prompt_from_task=True,
                reward_name="move_the_red_book_from_the_book_shelf_to_the_gray_box_topreward_reward",
                reward_beta=2.0,
                weight_scheme="awr_chunk",
                weight_quantile=None,
                weight_cutoff=None,
    ...
    # AWR chunk-weighted BC - red_book_05_21 - rbm
    TrainConfig(
        name="awr_chunk_red_book_rbm",
        model=pi0_config.Pi0Config(pi05=True, paligemma_variant="gemma_2b_lora"),
        data=LeRobotYAMDataConfig(
            repo_id="memmelma/red_book_05_21",
            base_config=DataConfig(
                prompt_from_task=True,
                reward_name="move_the_red_book_from_the_book_shelf_to_the_gray_box_rbm_reward",
                reward_beta=2.0,
                weight_scheme="awr_chunk",
                weight_quantile=None,
                weight_cutoff=None,
    ...
    # CFGRL advantage-conditioned BC - red_book_05_21 - topreward
    TrainConfig(
        name="cfgrl_red_book_topreward",
        model=pi0_config.Pi0Config(pi05=True, paligemma_variant="gemma_2b_lora"),
        data=LeRobotYAMDataConfig(
            repo_id="memmelma/red_book_05_21",
            base_config=DataConfig(
    ...
    # CFGRL advantage-conditioned BC - red_book_05_21 - rbm
    TrainConfig(
        name="cfgrl_red_book_rbm",
        model=pi0_config.Pi0Config(pi05=True, paligemma_variant="gemma_2b_lora"),
        data=LeRobotYAMDataConfig(
            repo_id="memmelma/red_book_05_21",
            base_config=DataConfig(
    ...
    # plain BC - pick_and_choose_05_23_bc (success-filtered)
    TrainConfig(
        name="bc_pick_and_choose_05_23",
        model=pi0_config.Pi0Config(pi05=True, paligemma_variant="gemma_2b_lora"),
        data=LeRobotYAMDataConfig(
            repo_id="memmelma/pick_and_choose_05_23",
            base_config=DataConfig(
                prompt_from_task=True,
                reward_name="success_reward",
                weight_quantile=None,
    ...
    # AWR chunk-weighted BC - pick_and_choose_05_23 - rvlm
    TrainConfig(
        name="awr_chunk_pick_and_choose_05_23",
        model=pi0_config.Pi0Config(pi05=True, paligemma_variant="gemma_2b_lora"),
        data=LeRobotYAMDataConfig(
            repo_id="memmelma/pick_and_choose_05_23",
            base_config=DataConfig(
                prompt_from_task=True,
                reward_name="put_the_white_book_on_top_of_the_left_bookshelf_rvlm_reward",
                reward_beta=2.0,
                weight_scheme="awr_chunk",
                weight_quantile=None,
                weight_cutoff=None,
    ...
    # AWR chunk-weighted BC - pick_and_choose_05_23 - topreward
    TrainConfig(
        name="awr_chunk_pick_and_choose_05_23_topreward",
        model=pi0_config.Pi0Config(pi05=True, paligemma_variant="gemma_2b_lora"),
        data=LeRobotYAMDataConfig(
            repo_id="memmelma/pick_and_choose_05_23",
            base_config=DataConfig(
                prompt_from_task=True,
                reward_name="put_the_white_book_on_top_of_the_left_bookshelf_topreward_reward",
                reward_beta=2.0,
                weight_scheme="awr_chunk",
                weight_quantile=None,
                weight_cutoff=None,
    ...
    # AWR chunk-weighted BC - pick_and_choose_05_23 - rbm
    TrainConfig(
        name="awr_chunk_pick_and_choose_05_23_rbm",
        model=pi0_config.Pi0Config(pi05=True, paligemma_variant="gemma_2b_lora"),
        data=LeRobotYAMDataConfig(
            repo_id="memmelma/pick_and_choose_05_23",
            base_config=DataConfig(
                prompt_from_task=True,
                reward_name="put_the_white_book_on_top_of_the_left_bookshelf_rbm_reward",
                reward_beta=2.0,
                weight_scheme="awr_chunk",
                weight_quantile=None,
                weight_cutoff=None,
    ...
    # CFGRL advantage-conditioned BC - pick_and_choose_05_23 - rvlm
    TrainConfig(
        name="cfgrl_pick_and_choose_05_23",
        model=pi0_config.Pi0Config(pi05=True, paligemma_variant="gemma_2b_lora"),
        data=LeRobotYAMDataConfig(
            repo_id="memmelma/pick_and_choose_05_23",
            base_config=DataConfig(
    ...
    # CFGRL advantage-conditioned BC - pick_and_choose_05_23 - topreward
    TrainConfig(
        name="cfgrl_pick_and_choose_05_23_topreward",
        model=pi0_config.Pi0Config(pi05=True, paligemma_variant="gemma_2b_lora"),
        data=LeRobotYAMDataConfig(
            repo_id="memmelma/pick_and_choose_05_23",
            base_config=DataConfig(
    ...
    # CFGRL advantage-conditioned BC - pick_and_choose_05_23 - rbm
    TrainConfig(
        name="cfgrl_pick_and_choose_05_23_rbm",
        model=pi0_config.Pi0Config(pi05=True, paligemma_variant="gemma_2b_lora"),
        data=LeRobotYAMDataConfig(
            repo_id="memmelma/pick_and_choose_05_23",
            base_config=DataConfig(
    ...
    TrainConfig(
        ...
        model=pi0_config.Pi0Config(pi05=True, paligemma_variant="gemma_2b_lora"),
        data=LeRobotYAMDataConfig(
            repo_id="memmelma/white_book_05_25",
            base_config=DataConfig(
                prompt_from_task=True,
                reward_name="success_reward",
                weight_quantile=None,
    ...
    # CFGRL advantage-conditioned BC - white_book_05_25 - rvlm - top 30%
    TrainConfig(
        name="cfgrl_white_book_rvlm_030",
        model=pi0_config.Pi0Config(pi05=True, paligemma_variant="gemma_2b_lora"),
        data=LeRobotYAMDataConfig(
            repo_id="memmelma/white_book_05_25",
            base_config=DataConfig(
    ...
    # CFGRL advantage-conditioned BC - white_book_05_25 - rvlm - top 50%
    TrainConfig(
        name="cfgrl_white_book_rvlm_050",
        model=pi0_config.Pi0Config(pi05=True, paligemma_variant="gemma_2b_lora"),
        data=LeRobotYAMDataConfig(
            repo_id="memmelma/white_book_05_25",
            base_config=DataConfig(
    ...
    # CFGRL advantage-conditioned BC - white_book_05_25 - rbm - top 30%
    TrainConfig(
        name="cfgrl_white_book_rbm_030",
        model=pi0_config.Pi0Config(pi05=True, paligemma_variant="gemma_2b_lora"),
        data=LeRobotYAMDataConfig(
            repo_id="memmelma/white_book_05_25",
            base_config=DataConfig(
    ...
    # CFGRL advantage-conditioned BC - white_book_05_25 - rbm - top 50%
    TrainConfig(
        name="cfgrl_white_book_rbm_050",
        model=pi0_config.Pi0Config(pi05=True, paligemma_variant="gemma_2b_lora"),
        data=LeRobotYAMDataConfig(
            repo_id="memmelma/white_book_05_25",
            base_config=DataConfig(
    ...
    # CFGRL advantage-conditioned BC - white_book_05_25 - topreward - top 30%
    TrainConfig(
        name="cfgrl_white_book_topreward_030",
        model=pi0_config.Pi0Config(pi05=True, paligemma_variant="gemma_2b_lora"),
        data=LeRobotYAMDataConfig(
            repo_id="memmelma/white_book_05_25",
            base_config=DataConfig(
    ...
    # CFGRL advantage-conditioned BC - white_book_05_25 - topreward - top 50%
    TrainConfig(
        name="cfgrl_white_book_topreward_050",
        model=pi0_config.Pi0Config(pi05=True, paligemma_variant="gemma_2b_lora"),
        data=LeRobotYAMDataConfig(
            repo_id="memmelma/white_book_05_25",
            base_config=DataConfig(
    ...
    # plain BC - candy_05_26 (success-filtered)
    TrainConfig(
        name="bc_candy_05_26",
        model=pi0_config.Pi0Config(pi05=True, paligemma_variant="gemma_2b_lora"),
        data=LeRobotYAMDataConfig(
    ...
    # CFGRL - candy_05_26 - topreward - top 30%
    TrainConfig(
        name="cfgrl_candy_05_26_topreward",
        model=pi0_config.Pi0Config(pi05=True, paligemma_variant="gemma_2b_lora"),
        data=LeRobotYAMDataConfig(
            repo_id="memmelma/candy_05_26",
            base_config=DataConfig(
    ...
    # CFGRL - candy_05_26 - robometer - top 30%
    TrainConfig(
        name="cfgrl_candy_05_26_robometer",
        model=pi0_config.Pi0Config(pi05=True, paligemma_variant="gemma_2b_lora"),
        data=LeRobotYAMDataConfig(
            repo_id="memmelma/candy_05_26",
            base_config=DataConfig(
    ...
    # CFGRL - candy_05_26 - rvlm - top 30%
    TrainConfig(
        name="cfgrl_candy_05_26_rvlm",
        model=pi0_config.Pi0Config(pi05=True, paligemma_variant="gemma_2b_lora"),
        data=LeRobotYAMDataConfig(
            repo_id="memmelma/candy_05_26",
            base_config=DataConfig(
    ...
    # plain BC - white_book_05_26 (success-filtered)
    TrainConfig(
        name="bc_white_book_05_26",
        model=pi0_config.Pi0Config(pi05=True, paligemma_variant="gemma_2b_lora"),
        data=LeRobotYAMDataConfig(
            repo_id="memmelma/white_book_05_26",
            base_config=DataConfig(
                prompt_from_task=True,
                reward_name="success_reward",
                weight_quantile=None,
    ...
    # CFGRL - white_book_05_26 - topreward - top 30%
    TrainConfig(
        name="cfgrl_white_book_05_26_topreward",
        model=pi0_config.Pi0Config(pi05=True, paligemma_variant="gemma_2b_lora"),
        data=LeRobotYAMDataConfig(
            repo_id="memmelma/white_book_05_26",
            base_config=DataConfig(
    ...
    # CFGRL - white_book_05_26 - robometer - top 30%
    TrainConfig(
        name="cfgrl_white_book_05_26_robometer",
        model=pi0_config.Pi0Config(pi05=True, paligemma_variant="gemma_2b_lora"),
        data=LeRobotYAMDataConfig(
            repo_id="memmelma/white_book_05_26",
            base_config=DataConfig(
    ...
    # CFGRL - white_book_05_26 - rvlm - top 30%
    TrainConfig(
        name="cfgrl_white_book_05_26_rvlm",
        model=pi0_config.Pi0Config(pi05=True, paligemma_variant="gemma_2b_lora"),
        data=LeRobotYAMDataConfig(
            repo_id="memmelma/white_book_05_26",
            base_config=DataConfig(
    ...
    # plain BC - ethernet_05_26 (success-filtered)
    TrainConfig(
        name="bc_ethernet_05_26",
        model=pi0_config.Pi0Config(pi05=True, paligemma_variant="gemma_2b_lora"),
        data=LeRobotYAMDataConfig(
    ...
    # CFGRL - ethernet_05_26 - robometer - top 30%
    TrainConfig(
        name="cfgrl_ethernet_05_26_robometer",
        model=pi0_config.Pi0Config(pi05=True, paligemma_variant="gemma_2b_lora"),
        data=LeRobotYAMDataConfig(
            repo_id="memmelma/ethernet_05_26",
            base_config=DataConfig(
    ...
    # CFGRL - ethernet_05_26 - rvlm - top 30%
    TrainConfig(
        name="cfgrl_ethernet_05_26_rvlm",
        model=pi0_config.Pi0Config(pi05=True, paligemma_variant="gemma_2b_lora"),
        data=LeRobotYAMDataConfig(
            repo_id="memmelma/ethernet_05_26",
            base_config=DataConfig(
